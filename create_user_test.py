...
def negative_assert_symbol(first_name):
    # Получаем в переменную user_body изменённое тело для запроса на создание пользователя
    user_body = get_user_body(first_name)
...
# Тест 7. Ошибка
# Параметр firstName запрещен с пробелами
...
# Тест 9. Ошибка
# Параметр firstName состоит из цифр
